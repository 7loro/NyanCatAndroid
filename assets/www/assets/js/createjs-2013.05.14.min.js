...
(function() {
    ...
    a.removeEventListener = function(b, g) {
        ...
        if (d) {
            var a = d[b];
            if (a) for (var c = 0, e = a.length; c < e; c++)
            if (a[c] == g) {
...
(function() {
    ...
    a.initialize = function(b) {
        ...
        if (null != b) {
            ...
            if (null != b.frames) if (b.frames instanceof Array) {
                this._frames = [];
                a = b.frames;
                g = 0;
                for (d = a.length; g < d; g++)
                e = a[g], this._frames.push({
                    image: this._images[e[4] ? e[4] : 0],
                    rect: new createjs.Rectangle(e[0], e[1], e[2], e[3]),
                    regX: e[5] || 0,
                    regY: e[6] || 0
                });
            } else d = b.frames, this._frameWidth = d.width, this._frameHeight = d.height, this._regX = d.regX || 0, this._regY = d.regY || 0, this._numFrames = d.count, 0 == this._loadCount && this._calculateFrames();
            if (null != (d = b.animations)) {
                ...
                for (var h in d) {
                    ...
                    e = d[h];
                    if ("number" == typeof e) a = b.frames = [e];
                    else if (e instanceof Array) if (1 == e.length) b.frames = [e[0]];
                    else {
                        b.frequency = e[3];
                        b.next = e[2];
                        a = b.frames = [];
                        for (g = e[0]; g <= e[1]; g++) a.push(g);
                    	}
                	}
            }else b.frequency = e.frequency, b.next = e.next, g = e.frames, a = b.frames = "number" ;//== typeof g ? [g] :
...
a.getFrameBounds = function(b) {
    ...
    if (!(this._frames || 0 == this._frameWidth)) {
        ...
        for (var b = 0, g = this._frameWidth, d = this._frameHeight, a = 0, c = this._images; a < c.length; a++) {
            for (var e = c[a], h = (e.width + 1) / g | 0, m = (e.height + 1) / d | 0, m = 0 < this._numFrames ? Math.min(this._numFrames - b, h * m) : h * m, k = 0; k < m; k++) this._frames.push({
                image: e,
                rect: new createjs.Rectangle(k % h * g, (k / h | 0) * d, g, d),
                regX: this._regX,
                regY: this._regY
            });
            b += m
...
(function() {
    ...
    b.draw = function(b) {
        ...
        for (var d = this._instructions, a = 0, c = d.length; a < c; a++) d[a].exec(b)
    };
    b.drawAsPath = function(b) {
        this._dirty && this._updateInstructions();
        for (var d, a = this._instructions, c = 0, e = a.length; c < e; c++)((d = a[c]).path || 0 == c) && d.exec(b)
    };
    ...
    b.beginLinearGradientFill = function(b, d, j, f, e, h) {
        ...
        f = 0;
        for (e = b.length; f < e; f++) j.addColorStop(d[f], b[f]);
    ...
    b.beginLinearGradientStroke = function(b, d, a, f, e, h) {
        ...
        f = 0;
        for (e = b.length; f < e; f++) a.addColorStop(d[f], b[f]);
    ...
    b.drawPolyStar = function(b, d, a, f, e, h) {
        ...
        for (var k = 0; k < f; k++) h += m, 1 != e && this._activeInstructions.push(new c(this._ctx.lineTo, [b + Math.cos(h) * a * e, d + Math.sin(h) * a * e])), h += m, this._activeInstructions.push(new c(this._ctx.lineTo, [b + Math.cos(h) * a, d + Math.sin(h) * a]));
        return this
    };
    b.decodePath = function(b) {
        for (var d = [this.moveTo, this.lineTo, this.quadraticCurveTo, this.bezierCurveTo, this.closePath], c = [2, 2, 4, 6, 0], f = 0, e = b.length, h = [], m = 0, k = 0, p = a.BASE_64; f < e;) {
            var s = b.charAt(f),
                ...
                t = r >> 3,
                v = d[t];
            if (!v || r & 3) throw "bad path data (@" + f + "): " + s;
            s = c[t];
            t || (m = k = 0);
            h.length = 0;
            f++;
...
(function() {
    ...
    a._applyFilters = function() {
        if (this.filters && 0 != this.filters.length && this.cacheCanvas) for (var b = this.filters.length, a = this.cacheCanvas.getContext("2d"), d = this.cacheCanvas.width, c = this.cacheCanvas.height, f = 0; f < b; f++) this.filters[f].applyFilter(a, 0, 0, d, c)
    };
...
(function() {
    ...
    a.addChild = function(b) {
        ...
        if (1 < a) {
            for (var d = 0; d < a; d++) this.addChild(arguments[d]);
    ...
    a.addChildAt = function(b, a) {
        var d = arguments.length,
            c = arguments[d - 1];
        if (0 > c || c > this.children.length) return arguments[d - 2];
        if (2 < d) {
            for (var f = 0; f < d - 1; f++) this.addChildAt(arguments[f], c + f);
    ...
    a.removeChild = function(b) {
        var a = arguments.length;
        if (1 < a) {
            for (var d = !0, c = 0; c < a; c++) d = d && this.removeChild(arguments[c]);
            return d
        }
    ...
    a.removeChildAt = function(b) {
        var a = arguments.length;
        if (1 < a) {
            for (var d = [], c = 0; c < a; c++) d[c] = arguments[c];
            d.sort(function(b, a) {
                return a - b
            });
            for (var f = !0, c = 0; c < a; c++) f = f && this.removeChildAt(d[c]);
            return f
        }
        if (0 > b || b > this.children.length - 1) return !1;
    ...
    a.getChildByName = function(b) {
        for (var a = this.children, d = 0, c = a.length; d < c; d++) if (a[d].name == b) return a[d];
        return null
    };
    ...
    a.clone = function(b) {
        var a = new c;
        this.cloneProps(a);
        if (b) for (var d = a.children = [], j = 0, f = this.children.length; j < f; j++) {
    ...
    a._getObjectsUnderPoint = function(b, a, d, j) {
        ...
        if (!this.hitArea && (this.cacheCanvas && h) && (this.getConcatenatedMatrix(e), f.setTransform(e.a, e.b, e.c, e.d, e.tx - b, e.ty - a), f.globalAlpha = e.alpha, this.draw(f), this._testHit(f))) return f.setTransform(1, 0, 0, 1, 0, 0), f.clearRect(0, 0, 2, 2), this;
        for (var m = this.children.length - 1; 0 <= m; m--) {
            ...
            if (k.visible && !(!p && !k.isVisible() || j && !k.mouseEnabled)) {
                ...
                if (k instanceof c && (!p || !s)) if (h) {
                    if (k = k._getObjectsUnderPoint(b, a)) return this
                } else {
                    if (k = k._getObjectsUnderPoint(b, a, d, j), !d && k) return k
                } else if (!j || h || s) if (k.getConcatenatedMatrix(e), p && (e.appendTransform(p.x, p.y, p.scaleX, p.scaleY, p.rotation, p.skewX, p.skewY, p.regX, p.regY), e.alpha = p.alpha), f.globalAlpha = e.alpha, f.setTransform(e.a, e.b, e.c, e.d, e.tx - b, e.ty - a), (p || k).draw(f), this._testHit(f)) {
...
(function() {
    ...
    a.enableDOMEvents = function(b) {
        ...
        if (!b && d) {
            for (a in d) b = d[a], b.t.removeEventListener(a, b.f);
            ...
            for (a in d) b = d[a], b.t.addEventListener(a, b.f)
        }
    };
    a.clone = function() {
        var b = new c(null);
    ...
    a._handlePointerMove = function(b, a, d, c) {
        if (this.canvas) {
            ...
            if (e || f.inBounds || this.mouseMoveOutside) {
                if (this.onMouseMove || this.hasEventListener("stagemousemove")) d = new createjs.MouseEvent("stagemousemove", f.x, f.y, this, a, b, b == this._primaryPointerID, f.rawX, f.rawY), this.onMouseMove && this.onMouseMove(d), this.dispatchEvent(d);
                if ((c = f.event) && (c.onMouseMove || c.hasEventListener("mousemove"))) d = new createjs.MouseEvent("mousemove", f.x, f.y, c.target, a, b, b == this._primaryPointerID, f.rawX, f.rawY), c.onMouseMove && c.onMouseMove(d), c.dispatchEvent(d, c.target)
            }
        }
    };
    ...
    a._handlePointerUp = function(b, a, d) {
        var c = this._getPointerData(b),
            f;
        if (this.onMouseMove || this.hasEventListener("stagemouseup")) f = new createjs.MouseEvent("stagemouseup", c.x, c.y, this, a, b, b == this._primaryPointerID, c.rawX, c.rawY), this.onMouseUp && this.onMouseUp(f), this.dispatchEvent(f);
        var e = c.event;
        if (e && (e.onMouseUp || e.hasEventListener("mouseup"))) f = new createjs.MouseEvent("mouseup", c.x, c.y, e.target, a, b, b == this._primaryPointerID, c.rawX, c.rawY), e.onMouseUp && e.onMouseUp(f), e.dispatchEvent(f, e.target);
        if ((e = c.target) && (e.onClick || e.hasEventListener("click")) && this._getObjectsUnderPoint(c.x, c.y, null, !0, this._mouseOverIntervalID ? 3 : 1) == e) f = new createjs.MouseEvent("click", c.x, c.y, e, a, b, b == this._primaryPointerID, c.rawX, c.rawY), e.onClick && e.onClick(f), e.dispatchEvent(f);
    ...
    a._handlePointerDown = function(b, a, d, c) {
        ...
        if (this.onMouseDown || this.hasEventListener("stagemousedown")) d = new createjs.MouseEvent("stagemousedown", f.x, f.y, this, a, b, b == this._primaryPointerID, f.rawX, f.rawY), this.onMouseDown && this.onMouseDown(d), this.dispatchEvent(d);
        if (c = this._getObjectsUnderPoint(f.x, f.y, null, this._mouseOverIntervalID ? 3 : 1)) if (f.target = c, c.onPress || c.hasEventListener("mousedown")) if (d = new createjs.MouseEvent("mousedown", f.x, f.y, c, a, b, b == this._primaryPointerID, f.rawX, f.rawY), c.onPress && c.onPress(d), c.dispatchEvent(d), d.onMouseMove || d.onMouseUp || d.hasEventListener("mousemove") || d.hasEventListener("mouseup")) f.event = d
    };
    a._testMouseOver = function() {
        if (-1 == this._primaryPointerID && !(this.mouseX == this._mouseOverX && this.mouseY == this._mouseOverY && this.mouseInBounds)) {
            ...
            if (a != b) {
                ...
                if (b && (b.onMouseOver || b.hasEventListener("mouseover"))) c = new createjs.MouseEvent("mouseover", d.x, d.y, b, null, -1, d.rawX, d.rawY), b.onMouseOver && b.onMouseOver(c), b.dispatchEvent(c);
    ...
    a._handleDoubleClick = function(b) {
        ...
        if (d && (d.onDoubleClick || d.hasEventListener("dblclick"))) evt = new createjs.MouseEvent("dblclick", a.x, a.y, d, b, -1, !0, a.rawX, a.rawY), d.onDoubleClick && d.onDoubleClick(evt), d.dispatchEvent(evt)
    };
    createjs.Stage = c
})();
this.createjs = this.createjs || {};
...
(function() {
    ...
    a._normalizeFrame = function() {
        var b = this._animation,
            ...
            d = this.paused,
            c;
        if (b) if (c = b.frames.length, this.currentAnimationFrame >= c) {
            var f = b.next;
        ...
        else c = this.spriteSheet.getNumFrames(), a >= c && !this._dispatchAnimationEnd(b, a, d, c - 1) && (this.currentFrame = 0)
    };
    ...
    a._goto = function(b) {
        ...
        } else this.currentAnimation = this._animation = null, this.currentFrame = b
    };
...
(function() {
    ...
    a._drawText = function(b) {
        ...
        for (var d = String(this.text).split(/(?:\r\n|\r|\n)/), c = this.lineHeight || this.getMeasuredLineHeight(), f = 0, e = 0, h = d.length; e < h; e++) {
            ...
            if (null == this.lineWidth || m < this.lineWidth) a && this._drawTextLine(b, d[e], f * c);
            else {
                for (var m = d[e].split(/(\s)/), k = m[0], p = 1, s = m.length; p < s; p += 2) b.measureText(k + m[p] + m[p + 1]).width > this.lineWidth ? (a && this._drawTextLine(b, k, f * c), f++, k = m[p + 1]) : k += m[p] + m[p + 1];
...
(function() {
    ...
    c._flip = function(a, b, g, d) {
        ...
        for (m = 0; m < j; m++) {
            ...
            e = k.frames;
            k = 0;
            for (p = e.length; k < p; k++) h.frames.push(e[k] + f * b);
            a[h.name] = h;
            d.push(h.name)
        }
    };
...
(function() {
    ...
    a.addMovieClip = function(b, a, d) {
        ...
        for (var e = b.timeline.duration, h = 0; h < e; h++) this.addFrame(b, j && j[h] ? j[h] : f, d, function(b) {
        ...
        if (b.length) {
            ...
            for (m = b.length; h < m; h++) {
                d = b[h].label;
                for (var j = a + (h == m - 1 ? e : b[h + 1].index), f = [], k = a + b[h].index; k < j; k++) f.push(k);
    ...
    a._run = function() {
        for (var b = 50 * Math.max(0.01, Math.min(0.99, this.timeSlice || 0.3)), a = (new Date).getTime() + b, d = !1; a > (new Date).getTime();) if (!this._drawNext()) {
            d = !0;
            break;
        }
        if (d) this._endBuild();
...
(function() {
    ...
    a.draw = function() {
        if (null != this.htmlElement) {
            ...
            if (this.visible) a.visibility = "visible";
            else return !0;
            var d = this._oldMtx || {};
            d.alpha != b.alpha && (a.opacity = "" + b.alpha, d.alpha = b.alpha);
            if (d.tx != b.tx || d.ty != b.ty || d.a != b.a || d.b != b.b || d.c != b.c || d.d != b.d) a.transform = a.WebkitTransform = a.OTransform = a.msTransform = ["matrix(" + b.a, b.b, b.c, b.d, b.tx + 0.5 | 0, (b.ty + 0.5 | 0) + ")"].join(), a.MozTransform = ["matrix(" + b.a, b.b, b.c, b.d, (b.tx + 0.5 | 0) + "px", (b.ty + 0.5 | 0) + "px)"].join(), this._oldMtx = b.clone();
            return !0
        }
    };
    a.cache = function() {};
...
(function() {
    ...
    c._IE_handleEvent = function(a, b) {
        if (a) {
            ...
            if ("MSPointerDown" == c) b.srcElement == a.canvas && (j[d] = !0, this._handleStart(a, d, b, b.pageX, b.pageY));
            else if (j[d]) if ("MSPointerMove" == c) this._handleMove(a, d, b, b.pageX, b.pageY);
            else if ("MSPointerUp" == c || "MSPointerCancel" == c) delete j[d], this._handleEnd(a, d, b)
        }
    };
...
(function() {
    ...
    c.removeTweens = function(b) {
        if (b.tweenjs_count) {
            for (var a = c._tweens, d = a.length - 1; 0 <= d; d--) a[d]._target == b && (a[d]._paused = !0, a.splice(d, 1));
            b.tweenjs_count = 0
        }
    };
    ...
    a._updateTargetProps = function(b, a) {
        ...
        for (n in this._initQueueProps) {
            if (null == (f = d[n])) d[n] = f = this._initQueueProps[n];
            if (null == (e = j[n])) j[n] = e = f;
            f = f == e || 0 == a || 1 == a || "number" != typeof f ? 1 == a ? e : f : f + (e - f) * a;
            var h = !1;
            if (e = c._plugins[n]) for (var m = 0, k = e.length; m < k; m++) {
    ...
    a._appendQueueProps = function(b) {
        ...
        for (h in b) {
            if (void 0 === this._initQueueProps[h]) {
                ...
                if (a = c._plugins[h]) {
                    j = 0;
                    for (f = a.length; j < f; j++) d = a[j].init(this, h, d)
                }
            ...
            if (a = c._plugins[h]) {
                e = e || {};
                j = 0;
                for (f = a.length; j < f; j++) a[j].step && a[j].step(this, h, d, b[h], e)
            }
...
(function() {
    ...
    a.addTween = function(a) {
        ...
        if (1 < c) {
            for (var d = 0; d < c; d++) this.addTween(arguments[d]);
            return arguments[0]
        }
        if (0 == c) return null;
        this.removeTween(a);
    ...
    a.removeTween = function(a) {
        var c = arguments.length;
        if (1 < c) {
            for (var d = !0, j = 0; j < c; j++) d = d && this.removeTween(arguments[j]);
            return d
        }
        if (0 == c) return !1;
    ...
    a.setPosition = function(a, c) {
        ...
        if (d == this._prevPos) return j;
        this._prevPosition = a;
        this.position = this._prevPos = d;
        for (var f = 0, e = this._tweens.length; f < e; f++) if (this._tweens[f].setPosition(d, c), d != this._prevPos) return !1;
        j && this.setPaused(!0);
        this.onChange && this.onChange(this);
        return j
    };
...
(function() {
    ...
    c.tween = function(a, b, g, d, j, f, e) {
        j = j.guide;
        if (void 0 == j || j === d.guide) return g;
    ...
    c.calc = function(a, b, g) {
        ...
        var d = a._segments,
            ...
            f = a._length * b,
            e = d.length - 2;
        for (b = 0; f > d[b] && b < e;) f -= d[b], b += 2;
        for (var d = d[b + 1], h = 0, e = d.length - 1; f > d[h] && h < e;) f -= d[h], h++;
        f = h / ++e + f / (e * d[h]);
        b = 2 * b + 2;
        e = 1 - f;
...
(function() {
    ...
    c.sendFileLoadEvent = function(a) {
        if (c.preloadHash[a]) for (var b = 0, g = c.preloadHash[a].length; b < g; b++) {
    ...
    c.registerPlugins = function(a) {
        for (var b = 0, g = a.length; b < g; b++) if (c.registerPlugin(a[b])) return !0;
        return !1
    };
    ...
    c.registerManifest = function(a) {
        for (var b = [], c = 0, g = a.length; c < g; c++) b[c] = createjs.Sound.registerSound(a[c].src, a[c].id, a[c].data, a[c].preload);
        return b
    };
    c.removeSound = function(b) {
        ...
        if (null == b) return !1;
        b = b.src;
        for (var g in c.idHash) c.idHash[g] == b && delete c.idHash[g];
        a.remove(b);
    ...
    c.removeManifest = function(a) {
        for (var b = [], c = 0, g = a.length; c < g; c++) b[c] = createjs.Sound.removeSound(a[c].src);
        return b
    };
    ...
    c.parsePath = function(a, b, g, e) {
        ...
        for (var h = a.length; e < h; e++) {
            ...
            var p = k[4],
                k = k[5];
            if (g[k] && -1 < c.SUPPORTED_EXTENSIONS.indexOf(k)) return b.name = p, b.src = m, b.extension = k, b
        }
        return null
    };
    ...
    c.setVolume = function(a) {
        ...
        c.masterVolume = a;
        if (!this.activePlugin || !this.activePlugin.setVolume || !this.activePlugin.setVolume(a)) for (var b = this.instances, g = 0, e = b.length; g < e; g++) b[g].setMasterVolume(a)
    };
    ...
    c.mute = function(a) {
        this.masterMute = a;
        if (!this.activePlugin || !this.activePlugin.setMute || !this.activePlugin.setMute(a)) for (var b = this.instances, c = 0, g = b.length; c < g; c++) b[c].setMasterMute(a)
    };
    ...
    c.playInstance = function(a, b, g, e, h, m, k) {
        ...
        null == k && (k = a.getPan());
        if (0 == g) {
            if (!c.beginPlaying(a, b, e, h, m, k)) return !1
        } else g = setTimeout(function() {
            c.beginPlaying(a, b, e, h, m, k)
        }, g), a.delayTimeoutId = g;
    ...
    c.playFinished = function(b) {
        a.remove(b);
        b = this.instances.indexOf(b); - 1 < b && this.instances.splice(b, 1)
    };
    ...
    var g = a.prototype = {
        ...
        removeAll: function() {
            for (; this.length;) this.instances[this.length - 1].stop()
        },
        getSlot: function(a) {
            for (var b, g, e = 0, h = this.max; e < h; e++) {
                b = this.get(e);
                if (null == b) return !0;
                if (!(a == c.INTERRUPT_NONE && b.playState != c.PLAY_FINISHED)) if (0 == e) g = b;
                else if (b.playState == c.PLAY_FINISHED || b.playState == c.PLAY_INTERRUPTED || b.playState == c.PLAY_FAILED) g = b;
                else if (a == c.INTERRUPT_EARLY && b.getPosition() < g.getPosition() || a == c.INTERRUPT_LATE && b.getPosition() > g.getPosition()) g = b
            }
...
(function() {
    ...
    c.isSupported = function() {
        ...
        if ("file:" == location.protocol && !a) return !1;
    ...
    c.generateCapabilities = function() {
        if (null == c.capabilities) {
            ...
            else if (window.AudioContext) c.context = new AudioContext;
            else return null;
            c.playEmptySound();
            c.capabilities = {
                panning: !0,
    ...
    a.prototype = {
        ...
        handleSoundReady: function() {
            if (null != window.createjs) if (1E3 * this.offset > this.getDuration()) this.playFailed();
            else {
...
(function() {
    ...
    c.prototype = {
        ...
        register: function(a, b) {
            ...
            for (var c = g.get(a), e = null, h = b || this.defaultNumChannels, m = 0; m < h; m++) e = this.createTag(a), c.add(e);
            return {
                tag: e,
                numChannels: h
            }
    ...
    a.prototype = {
        ...
        beginPlaying: function(a, b, c) {
            ...
            if (null == e) return this.playFailed(), -1;
    ...
    g.removeAll = function() {
        for (var a in g.tags) g.tags[a].removeAll();
        g.tags = {}
    };
...
(function() {
    ...
    a._sendProgress = function(a) {
        if (!this._isCanceled()) {
            var c = null;
            if ("number" == typeof a) this.progress = a, c = {
                loaded: this.progress,
                total: 1
            };
            else if (c = a, this.progress = a.loaded / a.total, isNaN(this.progress) || Infinity == this.progress) this.progress = 0;
            c.target = this;
            c.type = "progress";
    ...
    a._formatQueryString = function(a, c) {
        ...
        var d = [],
            j;
        for (j in a) d.push(j + "=" + escape(a[j]));
        c && (d = d.concat(c));
        return d.join("&")
    };
...
(function() {
    ...
    a.remove = function(a) {
        ...
        if (b) {
            for (; b.length;) {
                for (var c = b.pop(), f = this.getResult(c), e = this._loadQueue.length - 1; 0 <= e; e--) if (h = this._loadQueue[e].getItem(), h.id == c || h.src == c) {
                    this._loadQueue.splice(e, 1)[0].cancel();
                    break;
                }
                for (e = this._loadQueueBackup.length - 1; 0 <= e; e--) if (h = this._loadQueueBackup[e].getItem(), h.id == c || h.src == c) {
                ...
                else for (var e = this._currentLoads.length - 1; 0 <= e; e--) {
    ...
    a.installPlugin = function(a) {
        if (!(null == a || null == a.getPreloadHandlers)) {
            ...
            if (null != a.types) for (var b = 0, c = a.types.length; b < c; b++) this._typeCallbacks[a.types[b]] = a.callback;
            if (null != a.extensions) {
                b = 0;
                for (c = a.extensions.length; b < c; b++) this._extensionCallbacks[a.extensions[b]] = a.callback
            }
        }
    };
    ...
    a.loadManifest = function(a, b, c) {
        ...
        a = 0;
        for (var e = f.length; a < e; a++) this._addItem(f[a], c);
    ...
    a._createLoadItem = function(a) {
        ...
        if (b.type == createjs.LoadQueue.JSONP && null == b.callback) throw Error("callback is required for loading JSONP requests.");
        null == b.tag && (b.tag = this._createTag(b.type));
        if (null == b.id || "" == b.id) b.id = b.src;
    ...
    a._handleFileComplete = function(a) {
        ...
        if (this.maintainScriptOrder && b.type == createjs.LoadQueue.JAVASCRIPT) if (a instanceof createjs.TagLoader) this._currentlyLoadingScript = !1;
        else {
    ...
    a._removeLoadItem = function(a) {
        for (var b = this._currentLoads.length, c = 0; c < b; c++) if (this._currentLoads[c] == a) {
    ...
    a._updateProgress = function() {
        ...
        if (0 < b) {
            for (var c = 0, f = 0, e = this._currentLoads.length; f < e; f++) c += this._currentLoads[f].progress;
    ...
    Array.prototype.indexOf || (Array.prototype.indexOf = function(a) {
        ...
        if (f >= c) return -1;
        for (f = 0 <= f ? f : Math.max(c - Math.abs(f), 0); f < c; f++) if (f in b && b[f] === a) return f;
        return -1
    })
})();
this.createjs = this.createjs || {};
(function() {
    ...
    a.load = function() {
        ...
        if (a.type == createjs.LoadQueue.SVG || a.type == createjs.LoadQueue.JSONP || a.type == createjs.LoadQueue.JSON || a.type == createjs.LoadQueue.JAVASCRIPT || a.type == createjs.LoadQueue.CSS) this._startTagVisibility = c.style.visibility, c.style.visibility = "hidden", (document.body || document.getElementsByTagName("body")[0]).appendChild(c);
        null != c.load && c.load()
    };
    ...
    function b(c, d) {
        ...
        case "object":
            ...
            if ("[object Array]" === Object.prototype.toString.apply(u)) {
                t = u.length;
                for (e = 0; e < t; e += 1) q[e] = b(e, u) || "null";
                r = 0 === q.length ? "[]" : j ? "[\n" + j + q.join(",\n" + j) + "\n" + v + "]" : "[" + q.join(",") + "]";
                j = v;
                return r
            }
            if (h && "object" === typeof h) {
                t = h.length;
                for (e = 0; e < t; e += 1) "string" === typeof h[e] && (g = h[e], (r = b(g, u)) && q.push(a(g) + (j ? ": " : ":") + r))
            } else for (g in u) Object.prototype.hasOwnProperty.call(u, g) && (r = b(g, u)) && q.push(a(g) + (j ? ": " : ":") + r);
            r = 0 === q.length ? "{}" : j ? "{\n" + j + q.join(",\n" + j) + "\n" + v + "}" : "{" + q.join(",") + "}";
            j = v;
            return r
        }
